...
import { Literal, Symbol, Group, ArrayNode, Dict, FunCall, Caller, Filter, LookupVal, InlineIf, In, Is, And, Or, Not, Add, Concat, Sub, Mul, Div, FloorDiv, Mod, Pow, Neg, Pos, Compare, NodeList, Pair, TemplateData, } from './nodes';
...
class Compiler extends Obj {
    ...
    _compileExpression(node, frame) {
        ...
        // not.
        this.assertType(node, Literal, Symbol, Group, ArrayNode, Dict, FunCall, Caller, Filter, LookupVal, Compare, InlineIf, In, Is, And, Or, Not, Add, Concat, Sub, Mul, Div, FloorDiv, Mod, Pow, Neg, Pos, Compare, NodeList);
...
export const compile = (src, //TODO: check this is true
asyncFilters = [], extensions = [], name, opts) => {
    ...
    c.compile(transform(parser.parse(processedSrc, extensions, opts), asyncFilters) // TODO had 3 arguments name also
    );
    return c.getCode();
};
export default {
