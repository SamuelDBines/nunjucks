(function () {
	...
	if (typeof require !== 'undefined') {
		...
		WebLoader = require('../dist/src/web-loaders').WebLoader;
		FileSystemLoader = require('../dist/src/node-loaders').FileSystemLoader;
		NodeResolveLoader = require('../dist/src/node-loaders').NodeResolveLoader;
